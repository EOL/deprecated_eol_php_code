...
class SchemaParser
{
    public static function parse($full_url, &$connection)
    {
        $xml = simplexml_load_file($full_url, null, LIBXML_NOCDATA);
        $i = 0;
    ...
    public static function eol_schema_validate($full_url)
    {
        $errors = array();
        $warnings = array();
