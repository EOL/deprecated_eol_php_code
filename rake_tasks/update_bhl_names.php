...
function insert_titles()
{
    ...
    if(filesize(DOC_ROOT ."temp/titles.txt"))
    {
        ...
        $GLOBALS['db_connection']->load_data_infile(DOC_ROOT ."temp/titles.txt", "publication_titles_tmp");
...
function insert_items()
{
    ...
    if(filesize(DOC_ROOT ."temp/items.txt"))
    {
        ...
        $GLOBALS['db_connection']->load_data_infile(DOC_ROOT ."temp/items.txt", "title_items_tmp");
...
function insert_pages()
{
    ...
    if(filesize(DOC_ROOT ."temp/pages.txt"))
    {
        ...
        $GLOBALS['db_connection']->load_data_infile(DOC_ROOT ."temp/pages.txt", "item_pages_tmp");
...
function insert_page_names()
{
    ...
    if(filesize(DOC_ROOT ."temp/page_names.txt"))
    {
        ...
        $GLOBALS['db_connection']->load_data_infile(DOC_ROOT ."temp/page_names.txt", "page_names_tmp");
