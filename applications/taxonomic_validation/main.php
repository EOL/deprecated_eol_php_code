...
--->
    ...
    <tr><td>
            <font size="3">
            Taxa File (plain text, tsv or csv): a taxa file in Darwin Core Archive format, but without a meta.xml file. 
