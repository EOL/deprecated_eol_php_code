...
characters, respectively. They have no graphical representation but, 
...
<textarea name="list" rows="10" cols="50" >
</textarea>
...
<!---	
<br>	
	<input type="checkbox" name="visible" 	 value="" checked>Visible
	<input type="checkbox" name="published"  value="" checked>Published
	<input type="checkbox" name="vetted"  	 value="" checked>Vetted
--->
																								<br>
<input onClick="proc3()"  type="radio" name="choice2" value="4" 		>Without data objects 	<br>

<!---
<input onClick="proc3()"  type="radio" name="choice2" value="5" 		>Find 'Family' 	<br>
--->
...
&nbsp;&nbsp;&nbsp;&nbsp;
<!---
<input type="checkbox" name="withCSV">With CSV file output
--->
