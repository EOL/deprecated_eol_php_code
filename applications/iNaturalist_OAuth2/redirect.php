...
if($ret = curl_post_request($url, $arr)) {
    ...
    <form name='fn' action="https://editors.eol.org/eol_php_code/applications/BOLD2iNAT/main.php" method="post">

    */

    ?>
    Please wait, loading ...
    <form name='fn' action="http://localhost/eol_php_code/applications/BOLD2iNAT/main.php" method="post">
