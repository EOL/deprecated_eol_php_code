...
else exit("<hr>Please browse a CSV file to continue. <br> <a href='javascript:history.go(-1)'> &lt;&lt; Go back</a><hr>");
// ==================== */
/* current section from copied template section --- SEEMS NOT NEEDED ANYMORE Mar 2, 2021 Katie O.
