...
function show_name_he($hierarchy_entry, $indent, $expand)
{
    ...
    $display .= "<small><b><u>[$hierarchy_entry->lft]</u></b></small> <a href='browser.php?id=".$hierarchy_entry->id."'>".$hierarchy_entry->name()->string."</a> <small><b><u>[$hierarchy_entry->rgt]</u></b></small>";
