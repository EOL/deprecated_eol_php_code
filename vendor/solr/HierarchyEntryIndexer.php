...
class HierarchyEntryIndexer
{
    ...
    public function __construct()
    {
        ...
        if($r = Rank::find_or_create_by_label('kingdom')) $this->rank_labels[$r->id] = 'kingdom';
        if($r = Rank::find_or_create_by_label('regn.')) $this->rank_labels[$r->id] = 'kingdom';
        if($r = Rank::find_or_create_by_label('phylum')) $this->rank_labels[$r->id] = 'phylum';
        if($r = Rank::find_or_create_by_label('phyl.')) $this->rank_labels[$r->id] = 'phylum';
        if($r = Rank::find_or_create_by_label('class')) $this->rank_labels[$r->id] = 'class';
        if($r = Rank::find_or_create_by_label('cl.')) $this->rank_labels[$r->id] = 'class';
        if($r = Rank::find_or_create_by_label('order')) $this->rank_labels[$r->id] = 'order';
        if($r = Rank::find_or_create_by_label('ord.')) $this->rank_labels[$r->id] = 'order';
        if($r = Rank::find_or_create_by_label('family')) $this->rank_labels[$r->id] = 'family';
        if($r = Rank::find_or_create_by_label('fam.')) $this->rank_labels[$r->id] = 'family';
        //if($r = Rank::find_or_create_by_label('f.')) $this->rank_labels[$r->id] = 'family';
        if($r = Rank::find_or_create_by_label('genus')) $this->rank_labels[$r->id] = 'genus';
        if($r = Rank::find_or_create_by_label('gen.')) $this->rank_labels[$r->id] = 'genus';
        if($r = Rank::find_or_create_by_label('species')) $this->rank_labels[$r->id] = 'species';
        if($r = Rank::find_or_create_by_label('sp.')) $this->rank_labels[$r->id] = 'species';
    }
    ...
    private function lookup_synonyms($start, $limit, $filter = "1=1")
    {
        ...
        $common_name_id = SynonymRelation::find_or_create_by_label('common name')->id;
