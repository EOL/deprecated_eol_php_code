    ...
    filesize(CONTENT_RESOURCE_LOCAL_PATH . "31_working/media_resource.tab") > 1000)
{
    ...
    $GLOBALS['db_connection']->update("UPDATE resources SET resource_status_id=".ResourceStatus::find_or_create_by_translated_label('Harvest Requested')->id." WHERE id=31");
}
