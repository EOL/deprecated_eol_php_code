...
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Panthera leo'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'wolf'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Formicidae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Gadus morhua'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'fish Pisces'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'starfish Asteroidea'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Orca'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Shark Selachimorpha'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Pacific halibut'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Pale fox'

php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Chanos chanos'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Oreochromis niloticus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Polar bear'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Angiosperms'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Mus musculus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Rodentia'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Animalia'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Plantae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Virus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'ferns'

php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Acacia'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Panthera tigris'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Bald Eagle'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Aves'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'sunflower'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Rosa'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Hominidae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Fungi'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Coronaviridae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Tracheophyta'

php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Leuciscus cephalus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Gallinula chloropus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Cornales'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Proteales'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Felidae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Tyto alba'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Prunus dulcis'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Gagea minima'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Clematis vitalba'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Hyoscyamus niger'

php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Rhinocerotidae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Sciuridae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Vaccinium subg. Oxycoccus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Litchi chinensis'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Actinopterygii'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Esox lucius'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Hydroprogne caspia'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Fabaceae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Xenicus gilviventris'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Knightia excelsa'

php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Metrosideros excelsa'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Pterodroma macroptera'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Dacrydium cupressinum'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Himantopus novaezelandiae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Callaeas cinereus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Agathis australis'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Calamus baratangensis'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Adenoncos'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Ancistrochilus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Acanthephippium'

php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Cucumis sativus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Solanum lycopersicum'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Brassavola'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Convolvulus arvensis'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Orchidaceae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Onychoprion anaethetus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Senna alata'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Curcuma longa'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Anisoptera'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Solanum'

php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Euphorbia'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Aegolius funereus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Plegadis falcinellus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Turdus viscivorus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Meropidae'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Anser'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Prunus'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Cairina moschata'
php update_resources/connectors/wikipedia.php _ 'tg' generate_resource_force _ _ _ 'Jasminum'
