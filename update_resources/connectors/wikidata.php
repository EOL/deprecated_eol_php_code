...
// $func = new WikiDataAPI($resource_id, "en", true); //3rd param is boolean taxonomy; true means will generate hierarchy resource.
...
// $func = new WikiDataAPI($resource_id, "ru");
// $func = new WikiDataAPI($resource_id, "it");
// $func = new WikiDataAPI($resource_id, "pl");
// $func = new WikiDataAPI($resource_id, "vi");
// $func = new WikiDataAPI($resource_id, "pt");
$func = new WikiDataAPI($resource_id, "ja");
