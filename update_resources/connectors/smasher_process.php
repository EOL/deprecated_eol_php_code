...
$p["IOC"] = array("desc" => "IOC World Bird List", "url" => "http://localhost/cp/dynamic_hierarchy/smasher_TRAM991/ioc-birdlist/taxon.tab");
$p["MAM"] = array("desc" => "EOL Dynamic Hierarchy Mammals Patch", "url" => "http://localhost/cp/dynamic_hierarchy/smasher_TRAM991/eolmammalpatch/taxa.txt");
$p["LIZ"] = array("desc" => "EOL Dynamic Hierarchy Lizards Patch", "url" => "http://localhost/cp/dynamic_hierarchy/smasher_TRAM991/eollizardspatch/EOLlizardPatch.txt");
$p["ODO"] = array("desc" => "World Odonata List", "url" => "http://localhost/cp/dynamic_hierarchy/smasher_TRAM991/worldodonatalist/taxa.txt");
$p["BOM"] = array("desc" => "A global checklist of the Bombycoidea", "url" => "http://localhost/cp/dynamic_hierarchy/smasher_TRAM991/kitchingetal2018/taxa.txt");
$p["ERE"] = array("desc" => "EOL Dynamic Hierarchy Erebidae Patch", "url" => "http://localhost/cp/dynamic_hierarchy/smasher_TRAM991/eoldynamichierarchyerebidaepatch/taxon.txt");
