...
/* 'lij' temporarily removed in 2nd batch. Prob. with lang code.
*/
$langs[2] = array('lez', 'sa', 'yi', 'ace', 'diq', 'ce', 'yo', 'rw', 'vec', 'sc', 'ln', 'hak', 'kw', 'bcl', 'za', 'ang', 'eml', 'av', 'chy', 'fj', 'ik', 'ug', 'zea', 'bxr', 'zh-classical', 'bjn', 'so', 'arz', 'mwl', 'sn', 'chr', 
