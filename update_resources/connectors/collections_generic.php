...
e.g.
- LD_afrotropicalbirds.tar.gz               ---> for text objects
- LD_afrotropicalbirds_multimedia.tar.gz    ---> for media objects
*/
...
$info['AnAge_text'] = array('id' => 195, 'LD_domain' => 'http://www.eol.org/content_partners/33/resources/40', 'OpenData_title' => 'AnAge text', 'resource_id' => 40);
$xml_path['AnAge_text'] = "http://localhost/cp_new/OpenData/EOLxml_2_DWCA/".$ld."/anagetext.xml.gz";
...
// /* normal operation
foreach($final as $ld) {
    $params[$lifedesk]["local"]["lifedesk"] = $xml_path[$ld];
