...
estimated execution time: 9 mins.
...
$resource_path = Functions::get_accesspoint_url_if_available($resource_id, "http://collections.mnh.si.edu/services/eol/nmnh-ento-response.xml.gz"); //NMNH Entomology resource
echo "\n processing resource:\n $resource_path \n\n";
