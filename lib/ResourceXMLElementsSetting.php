...
class ResourceXMLElementsSetting
{
    ...
    public function load_xml_string($expire_seconds = 60*60*24*25)
    {
        ...
        elseif(preg_match("/^(.*)\.(xml)$/", $this->xml_path, $arr)) {
            ...
            echo "\nInput file not processed. Script to determine what type of file, is not yet created.\n";
            return false;
        }
        debug("local xml path: " . $this->xml_path);
    }
