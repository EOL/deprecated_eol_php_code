...
class TucanesAPI
{
    ...
    public static function get_all_taxa()
    {
        ...
        foreach($taxa as $taxon)
        {
            ...
            $arr = self::get_tucanes_taxa($taxon, $used_collection_ids);
            $page_taxa               = $arr[0];
    ...
    public static function get_tucanes_taxa($taxon, $used_collection_ids)
    {
    ...
    {
        if(in_array($lang, array("English", "en", "EN"))) return "en";
        elseif(in_array($lang, array("Español", "es", "ES"))) return "es";
        elseif(in_array($lang, array("Portugués", "pt", "PT"))) return "pt";
        else return "";
    }
    ...
    private function get_agents($taxon_text)
    {
        ...
        {
            $creators = str_ireplace("Autor:", "", $taxon_text["http://purl.org/dc/terms/creator"]);
