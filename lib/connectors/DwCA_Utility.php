...
class DwCA_Utility
{
    ...
    {   /* param $preferred_rowtypes is the option to include-only those row_types you want on your final DwCA. 1st client was DATA-1770 */
        ...
        elseif(in_array($this->resource_id, array("gbif_classification", "gbif_classification_without_ancestry", "gbif_classification_final", 
                                                  "26", "368_removed_aves", "617_ENV", "wikipedia_en_traits_FTG", "10088_5097_ENV", "10088_6943_ENV", "118935_ENV"))) {
        ...
        foreach($index as $row_type) {
            ...
            */
            ...
            if(@$this->extensions[$row_type]) { //process only defined row_types
                ...
                // /* customized
                if(in_array($this->resource_id, array("10088_5097_ENV", "10088_6943_ENV", "118935_ENV")) && $row_type == "http://rs.tdwg.org/dwc/terms/occurrence") {
        ...
        */
        ...
        if(in_array($this->resource_id, array("21_ENV", "617_ENV", "26_ENV", "10088_5097_ENV", "10088_6943_ENV", "118935_ENV")) || $annotateYes) { //first 2 clients: Amphibiaweb, Wikipedia EN
