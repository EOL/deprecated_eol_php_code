...
class IUCNRedlistAPI
{
    ...
    */
    ...
    public function get_taxa_for_species($species_json, $species_id = NULL)
    {
        ...
        $taxon_parameters['source'] = "http://apiv3.iucnredlist.org/api/v3/website/".str_replace(' ', '%20', $scientific_name); //e.g. http://apiv3.iucnredlist.org/api/v3/website/Panthera%20leo
    ...
    function get_taxa_for_species_V2($species_id)
    {
        ...
        $download_options['download_wait_time'] = 1500000; //just temporary until I get my own token
