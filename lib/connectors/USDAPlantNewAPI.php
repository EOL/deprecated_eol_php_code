...
class USDAPlantNewAPI
{
    ...
    {   //print_r($imgs); //exit;
        ...
        foreach($imgs as $img) {
            ...
            $mr->UsageTerms             = 'http://creativecommons.org/licenses/publicdomain/'; //'https://creativecommons.org/publicdomain/zero/1.0/'; //'http://creativecommons.org/licenses/by-nc-sa/3.0/';
