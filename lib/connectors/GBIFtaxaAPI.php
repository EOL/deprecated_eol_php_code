...
This was generated by this script: eol_php_code/applications/genHigherClass/generate_cmd.php
*/
class GBIFtaxaAPI
{
    ...
    function prune_gbif_backbone_taxa()
    {
        $taxonIDs = array(8, 7707728, 13, 35, 9, 212); //GBIF taxonID

        // /* testing...
        // $children = self::get_children(8);
        $children = self::get_all_children_of_taxon(212); //8
        print_r($children);
