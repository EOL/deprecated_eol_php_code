...
class GBIFoccurrenceAPI_DwCA //this makes use of the GBIF DwCA occurrence downloads
{
    function __construct()
    {
        ...
        $this->download_options = array(
            'expire_seconds'     => 60*60*24*30*3, //3 months to expire
    ...
    function jenkins_call($group, $batches, $connector_task)
    {
        ...
        */
        ...
        foreach($batches as $batch) {
            ...
            sleep(30); //this is important so Jenkins will detect that the first job is already taken and will use the next available job.
            // */
        }
    }
