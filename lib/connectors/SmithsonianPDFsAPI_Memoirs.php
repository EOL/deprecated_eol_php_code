...
*/
class SmithsonianPDFsAPI_Memoirs extends ParseListTypeAPI_Memoirs
{
    public function __construct($folder)
    {
        ...
        if(Functions::is_production()) $this->path['working_dir'] = '/extra/other_files/Smithsonian/MoftheAES/';
        else                           $this->path['working_dir'] = '/Volumes/AKiTiO4/other_files/Smithsonian/MoftheAES/';
    ...
    function generate_dwca_for_a_repository()
    {   
            ...
            foreach($a[1] as $str) { //echo("\n[$str]\n");
                ...
                if(preg_match("/>(.*?)elicha/ims", $str."elicha", $a2)) {
                    ...
                    */
                    ...
                    if(!in_array($pdf_id, array('120602', '91225', '91362', '118935', '118946', '30355'))) { //not needed here '118936'...it seems.
                        $words = explode(" ", $tmp);
