...
class iNatImagesSelectAPI
{
    ...
    {   
        ...
        // $this->broken_images = array(); //un-comment for now, until a new list of broken images is generated. But comment in real operation.
        // */
        ...
        /* for Jen's flowering plants report --- should be commented in normal operation
    ...
    private function get_inat_broken_images_list()
    {
        ...
        echo("\nTotal broken images A: ".count($arr)."\n");
        foreach($arr as $url) $final[$url] = '';
        echo("\nTotal broken images B: ".count($final)."\n"); // print_r($final);
        return $final;
    }
}
?>