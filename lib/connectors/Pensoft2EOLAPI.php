    ...
    {   
        ...
        */
        ...
        if(in_array($this->param['resource_id'], array("10088_5097_ENV", "10088_6943_ENV", "118935_ENV", "120081_ENV", "120082_ENV", "118986_ENV", "118920_ENV", "120083_ENV", 
            "118237_ENV", "MoftheAES_ENV", "15423_ENV", "91155_ENV"))) $excluded_rowtypes = array('http://eol.org/schema/media/document');
        ...
        foreach(new FileIterator($meta->file_uri) as $line => $row) {
            ...
            */
            ...
            if(self::valid_record($rec)) {
                ...
                if(in_array($this->param['resource_id'], array("120081_ENV", "120082_ENV", "118986_ENV", "118920_ENV", "120083_ENV", "118237_ENV", "MoftheAES_ENV", "15423_ENV", "91155_ENV"))) $this->ontologies = "envo,eol-geonames";
                // ---------------------- end customize ----------------------*/
        ...
        */
        foreach($arr as $rek) {
            ...
            if(in_array($this->param['resource_id'], array("118935_ENV", "120081_ENV", "120082_ENV", "118986_ENV", "118920_ENV", 
                    "120083_ENV", "118237_ENV", "MoftheAES_ENV"))) {
