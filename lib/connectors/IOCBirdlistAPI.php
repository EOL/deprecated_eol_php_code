...
class IOCBirdlistAPI
{
            ...
            foreach($o->family as $f)
            {
                ...
                foreach($f->genus as $g)
                {
                    ...
                    foreach($g->species as $s)
                    {
                        ...
                        $rek['species']['english'] = (string) $s->english;
    ...
    private function create_taxa($rek)
    {   /*
    [order] => Array
    ...
    [subspecies] => Array
        ...
        */
        ...
        $ranks = array('order', 'family', 'genus', 'species', 'subspecies');
    ...
    private function prepare_names($rek) //taxon and parent
    {
        /*
        [order] => Array
                [latin] => STRUTHIONIFORMES
        ...
        */
        ...
        $rek['subspecies']['parent'] = $rek['species']['taxon'];
        return $rek;
    }

    private function create_aves()
    {
        $taxon = new \eol_schema\Taxon();
