...
class RelateHierarchies
{
    ...
    private function start_comparing_entry_from_solr(&$entry_from_solr)
    {
        ...
        if($this->total_entry_comparisons % 100 == 0 && $GLOBALS['ENV_DEBUG'])
        {
    ...
    private function finalize_process()
    {
        ...
        $this->mysqli->load_data_infile($this->relationships_temp_file_path, $this->relations_table_name, 'IGNORE', '', 500000, 500000);
