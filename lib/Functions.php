...
class Functions
{
    ...
    public static function is_within_folders_where_file_change_is_allowed($file)
    {
        ...
        , '/Volumes/AKiTiO4/d_w_h/', 'eol_php_code/applications/content_server/resources_2/', '/Volumes/AKiTiO4/eol_php_code_tmp/', '/extra/eol_php_code_tmp/', 'temp/'); //allowed folders so far; we can add more.
