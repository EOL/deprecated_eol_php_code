...
public static $mapping = array(
		...
		"http://mimi.case.edu/ontologies/2009/1/UnitsOntology#US_pound" => array( "n_unit" => "http://mimi.case.edu/ontologies/2009/1/UnitsOntology#US_pound",
			...
			"http://eol.org/schema/terms/practicalSalinityUnits" => array( "n_unit" => "http://eol.org/schema/terms/practicalSalinityUnits",
																						 "n_value" => 1),
			"95% confidence" => array( "n_unit" => "95% confidence",
																						 "n_value" => 1),
			"http://purl.obolibrary.org/obo/EFO_0004387" => array( "n_unit" => "http://purl.obolibrary.org/obo/EFO_0004387",
																						 "n_value" => 1),
			"sssssssshttp://purl.obolibrary.org/obo/UO_0000016" => array( "n_unit" => "sssssssshttp://purl.obolibrary.org/obo/UO_0000016",
																						 "n_value" => 1));
	
	public static function normalize_value($actual_value, $actual_unit){
		if ($actual_value && trim($actual_value) != ""){
			$mapping = Functions::$mapping[$actual_unit]["n_value"];
			if ($mapping != 0){
					return $mapping * $actual_value;
			}else{
	...
	public static function normalize_unit($actual_unit){
		if ($u = Functions::$mapping[$actual_unit]["n_unit"]){
			return $u;
		}		
		return $actual_unit;
	}
